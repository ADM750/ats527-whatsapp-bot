...
import { IParsedArgs, ISimplifiedMessage , GroupSettingChange, MessageType, WAGroupMetadata, WAGroupModification, WAMessage } from '../../typings'
...
export default class Command extends BaseCommand {
    ...
    run = async (text: string, M: WAMessage): Promise<string> => {
